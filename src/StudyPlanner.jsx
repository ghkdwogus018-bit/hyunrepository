...
const COURSES = [
  ...
  // 국어 — 이선재 2027 커리큘럼 순서 (1주차부터 시작)
  ["국어", "나비효과 입문 (노베이스)", 18, 1, 4],
  ["국어", "이선재 올인원 (기본이론)", 36, 5, 10],
  ["국어", "이선재 독해 신공", 24, 11, 16],
  ["국어", "이선재 기출실록", 35, 17, 25],
  ["국어", "이선재 신유형 특강", 14, 26, 30],
  ["국어", "이선재 동형 모의고사", 20, 31, 40],
  ["국어", "봉투모의고사·파이널", 10, 41, 47],
