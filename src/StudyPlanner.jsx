...
const COURSES = [
  // 영어 — 심우철 2027 커리큘럼 순서 (노베이스 → 완성)
  ["영어", "심슨 영기싹 (노베이스 입문)", 32, 1, 6],
  ["영어", "심슨 구문 독해", 20, 7, 10],
  ["영어", "심슨 그래머 (문법)", 28, 11, 15],
  ["영어", "심슨 독해", 28, 16, 20],
  ["영어", "심슨 유형별 기출", 36, 21, 26],
  ["영어", "심슨 하프·진가 모의고사", 30, 27, 36],
  ["영어", "심슨 동형 모의고사·파이널", 24, 37, 46],
  // 국어 — 이선재 2027 커리큘럼 순서 (문법 먼저 → 기본이론 → 기출 → 독해 → 동형)
  ["국어", "이선재 공문법 (공무원 문법)", 30, 1, 5],
  ["국어", "이선재 문법 강좌 (신유형 문법)", 18, 6, 8],
  ["국어", "이선재 올인원 (문학·독해·어휘)", 40, 9, 16],
  ["국어", "이선재 기출실록 (기출)", 35, 17, 25],
  ["국어", "이선재 독해 알고리즘", 20, 26, 30],
  ["국어", "이선재 신유형·추론 특강", 14, 31, 34],
  ["국어", "이선재 동형 모의고사", 20, 35, 40],
  ["국어", "봉투모의고사·파이널", 12, 41, 47],
  // 행정법 — 행정학과 동일한 주차 경계 (매일 짝으로 진행)
  ["행정법", "행정법으로의 초대(입문)", 18, 1, 4],
  ["행정법", "써니 행정법총론 올인원", 76, 5, 16],
  ["행정법", "써니 기출문제 풀이", 40, 17, 25],
  ["행정법", "핵심집약", 30, 26, 30],
  ["행정법", "단원별·실전 동형", 24, 37, 46],
  // 행정학 — 행정법과 동일한 주차 경계 (매일 짝으로 진행)
  ["행정학", "행정학 입문 특강", 14, 1, 4],
